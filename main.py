...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-mode',type=str,default='whole',help='sample/whole sage:sample gat:sample/whole cheb:whole')
    ...
    parser.add_argument('--num-layers',type=int,default=1,help='GAT / GraphSAGE')
